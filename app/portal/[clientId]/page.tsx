  ...
  return (
    <div style={{ minHeight: "100vh", background: "#09090b", color: "#ccc8c8", padding: "60px 40px" }}>
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        {/* Administration Section - Updated to match your data structure */}
        <div style={{ 
          marginTop: "80px", 
          padding: "24px", 
          border: "1px solid #1e1c1a", 
          ...
          <div style={{ display: "flex", gap: "40px", marginTop: "16px", fontSize: "13px" }}>
            <div>
              <span style={{ color: "#5a5248" }}>Service Status:</span> {client.agreement?.status || "N/A"}
            </div>
            <div>
              <span style={{ color: "#5a5248" }}>Plan:</span> {client.agreement?.tier || "N/A"}
            </div>
          </div>
        </div>
      </div>
